namespace Oloraculo.Web.Models
{
        ...
        DateTimeOffset? FetchedAt = null, string? Notes = null)
    {
        ...
        public static SourceMetadata AvailabilityNews => new SourceMetadata("Availability News", "news", Notes: "Curated news sources classified with DeepSeek via OpenRouter");
